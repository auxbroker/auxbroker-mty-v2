 ...
 */
export async function mostrarOpcionesContacto(tarjeta, telefonoEmisor, pais, textoInteres) {
  ...
  // 1️⃣ Registrar contacto en tabla "contactos"
